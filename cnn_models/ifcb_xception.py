# -*- coding: utf-8 -*-
"""Edited script version of notebook used to create Xception based model.

Notes:
- Originally generated by Colaboratory.
- Original file is located at
    https://colab.research.google.com/drive/1JvT5du2axnP2DrQ3FI841p-rDyR-DrJP
- Trained on labeled dataset provided by Alexis Fischer - Kudela Lab (UCSC)
- Validation accuracy of 0.9836 after 32 epochs
"""
import click
...
def main(output_dir, train_path, val_path, batch_size=200):
